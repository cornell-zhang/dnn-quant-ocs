...
def load_data(dataset, data_dir, batch_size, workers, valid_size=0.1, deterministic=False, crop_size=224):
    """Load a dataset.
    ...
    if dataset == 'imagenet':
        return imagenet_load_data(data_dir, batch_size, workers, valid_size=valid_size, deterministic=deterministic, crop_size=crop_size)
...
def imagenet_load_data(data_dir, batch_size, num_workers, valid_size=0.1, deterministic=False, crop_size=224):
